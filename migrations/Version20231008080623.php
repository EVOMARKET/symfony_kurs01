 ...
 */
final class Version20231008080623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT NOT NULL, article_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, alt VARCHAR(255) DEFAULT NULL, relation VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
